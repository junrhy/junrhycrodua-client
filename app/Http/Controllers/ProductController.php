...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $res = Http::withHeaders([
                ...
                ->get(env('ENDPOINT_HOST') . '/api/products');
        ...
        if ($res->json('success') !== null && $res->json('success')) {
            ...
            while ($current_page < $last_page + 1) {
                $response = Http::withHeaders([
                        ...
                        ->get(env('ENDPOINT_HOST') . '/api/products?page=' . $current_page);
        ...
        return view('sections.product.index', [
    ...
    public function store(Request $request)
    {
        ...
        $response = Http::withHeaders([
            ...
            ->post(env('ENDPOINT_HOST') . '/api/products');
    }
