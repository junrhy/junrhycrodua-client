...
@section('content')
<h1 class="border-bottom border-success border-3">Services</h1>

<ul class="nav nav-tabs mb-3" id="salesTab" role="tablist">
   <li class="nav-item" role="presentation">
    <button class="nav-link active" id="service-tab" data-bs-toggle="tab" data-bs-target="#service" type="button" role="tab" aria-controls="service" aria-selected="true">Lists</button>
   </li>
</ul>
...
<div class="tab-content" id="productsTabContent">
   <div class="tab-pane fade show active" id="service" role="tabpanel" aria-labelledby="service-tab">
      <div class="table-responsive">
         <table id="serviceTable" class="stripe hover">
            <thead>
               <tr>
                  <th width="5%"></th>
                  <th>Name</th>
...
$(document).ready(function(){
   ...
   let productTable = $('#serviceTable').DataTable( {
         dom: 'Bfrtip',
         lengthMenu: [
            [ 10, 25, 50, -1 ],
            ...
            },
            {
               ...
               (async () => {
                  ...
                  html:
                      ...
                      '<select id="newServiceCurrency" class="form-select mb-3"></select>' +
                  ...
                  didOpen: () => {
                     ...
                     $("#newServiceCurrency").append("<option selected>Select Currency</option>");

                     for (var key in currencies) {
                        $("#newServiceCurrency").append("<option value='"+currencies[key]+"'>"+key+"</option>");
                     }
                  },
                  preConfirm: () => {
                     return [
                        ...
                        document.getElementById('newServiceCurrency').value,
         ...
         drawCallback: function() {
            ...
            for (var i = 0; i < api.page.len() - (rowCount === 0? 1 : rowCount); i++) {
              $('#serviceTable tbody').append($("<tr><td>&nbsp;</td><td></td><td></td><td></td><td></td><td></td></tr>"));
            }
         }
   });
});
